...
def run_each_generation(program_list, generation_count, df, gap, tdp, MAX_PROGRAM_SIZE,
    ...
    training_prediction_error, program_list, dt_obj = data_module_mapping[dataset].train_gp_classifier(generation_count, program_list, training_prediction_error, fitness_scores,
